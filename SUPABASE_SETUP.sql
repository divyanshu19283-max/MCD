-- LocalFix / Report-It-Now: one-time Supabase setup
-- Run this entire file in Supabase Dashboard -> SQL Editor.
-- It is safe for an existing complaints table: routing columns use IF NOT EXISTS.
-- After it succeeds, restart the local Vite server.
